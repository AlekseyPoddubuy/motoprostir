...
class OptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create option" do
    assert_difference('Option.count') do
      post options_url, params: { option: { name: @option.name, optable_id: @option.optable_id, optable_type: @option.optable_type, value: @option.value } }
    end
  ...
  test "should update option" do
    patch option_url(@option), params: { option: { name: @option.name, optable_id: @option.optable_id, optable_type: @option.optable_type, value: @option.value } }
